<template>
    <admin-authenticated-layout>  
        <div>
            <h2 class="text-xl text-gray-900 font-semibold border-b-2 border-gray-900">Suppliers</h2>

            <div class="mt-5">
                <div class="mb-6 flex justify-end items-center">
                    <app-primary-link :href="route('admin.suppliers.create')">
                        Create
                    </app-primary-link>
                </div>
                ...
                <div class="bg-white rounded shadow overflow-x-auto">
                    <table class="w-full whitespace-no-wrap">
                        ...
                        <tr v-for="supplier in suppliers" :key="supplier.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
                            ...
                            <td class="border-t px-6 py-2 text-center space-x-2">
                                <inertia-link 
                                    :href="route('admin.suppliers.edit', supplier.slug)" 
                                ...
                                <button 
                                    ...
                                    @click.prevent="deleteModel(route('admin.suppliers.destroy', supplier.slug))"
                                >
